...
<header>
	...
	<nav class="inline-flex lg:flex items-start justify-between flex-wrap p-6 w-full lg:w-[85%] mx-auto h-min">
		<div id="logo" class="flex items-center flex-shrink-0 text-white mr-6 flex-[100] w-fit h-1/2">
			<div id="loggedIn" class="mr-8 flex flex-row items-center border px-4 py-4 rounded-xl hover:bg-[#A7C7E7] text-black"><img src="https://cdn.discordapp.com/avatars/125998088409055233/7943dcc69762855669986f04e3e9bb7f.png" alt="your Discord profile" class="rounded-full mr-4" height=40 width=40 /><h4 class="font-bold text-lg">Kaevex</h4></div>
		...
		<div class="w-full block flex-grow hidden lg:flex lg:w-auto font-medium ">
			<div class="text-sm lg:flex-grow inline-flex items-center mt-5" >
