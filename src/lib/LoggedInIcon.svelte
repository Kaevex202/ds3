...
<div id="userInfo" >
    ...
    on:click={expandMenu}
    id="loggedIn"
    class="mr-8 flex flex-row items-center justify-evenly border w-[7vw] items-center py-2 rounded-xl bg-blue-200 hover:bg-blue-300 focus:ring-2 focus:outline-none focus:ring-blue-300 text-black"
    type="button"
    >
