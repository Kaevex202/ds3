<script>
    ...
    let challenge = "<div class=\" italic text-lg font-medium mt-2\">Bosses allowed to be killed without Morne's Great Hammer:</div><p>Iudex Gundyr<br/>Vordt of the Boreal Valley<br/>Crystal Sage</p><br/><div class=\" italic text-lg font-medium mt-2\">Extra restrictions</div><p>May not use any other weapon/item for damage after obtaining the Astora Greatsword.<br/>General <a href=\"https://www.speedrun.com/darksouls3?h=Any_Glitchless&x=jdz6v9v2\" class=\"font-semibold hover:underline text-[#105D97]\" rel=\"nofollow\">Any% Glitchless rules apply.</a><br/>Fall Damage Cancel Allowed.<br/>Fence Skip Allowed.<br/>Greatwood Skip Allowed.<br/>Scream Skip Allowed.<br/>Wyvern Skip Allowed.<br/>Only non-damaging spells are allowed to be cast.<br/>Quitouts allowed.</p>";
