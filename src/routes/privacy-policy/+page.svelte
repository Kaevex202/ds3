<svelte:head>
    <title>SoulsBorneChallenges - Privacy Policy</title> 
    <meta name="description" content="Privacy Policy for SoulsBorneChallenges.com">
</svelte:head>

<div class=" flex flex-col mx-auto mt-16 items-center px-6 lg:px-0 dark:text-[#F7EBE8]">
    <h1 class="text-4xl font-extrabold md:text-7xl mt-4 mb-8 2xl:mt-12 px-4 lg:px-0 ">PRIVACY POLICY</h1>
    <div class="lg:w-4/5 xl:w-7/12 2xl:w-5/12">
            <h5>Last updated August 30, 2023</h5>
            <p class="text-lg mt-2">
            This privacy notice for SoulsBorneChallenges ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
            Visit our website at http://www.soulsbornechallenges.com, or any website of ours that links to this privacy notice
            ...
            <h4 class="mt-8">SUMMARY OF KEY POINTS</h4>
            ...
            How do you exercise your rights? The easiest way to exercise your rights is by visiting https://soulsbornechallenges.com/account, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
        </p><p class=" text-sm mt-2">
            Want to learn more about what we do with any information we collect? Review the privacy notice in full.
        </p>
            
            <h2 class="mt-8">TABLE OF CONTENTS</h2>
            <p class=" text-sm mt-2">
            ...
            16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?<br/></p>
            
            
            <h2 class="mt-8">1. WHAT INFORMATION DO WE COLLECT?</h2>
            <p class=" text-sm mt-2">
            ...
            <h2 class="mt-8">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p class=" text-sm mt-2">
            ...
            <h2 class="mt-8">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
            <p class=" text-sm mt-2">
            ...
            <br/>Affiliates. We may share your information with our affiliates, in which case we will require those affiliates to honor this privacy notice. Affiliates include our parent company and any subsidiaries, joint venture partners, or other companies that we control or that are under common control with us.
            <br/> Business Partners. We may share your information with our business partners to offer you certain products, services, or promotions.
        </p>
        <h2 class="mt-8">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
            <p class=" text-sm mt-2">
            ...
            <h2 class="mt-8">6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
            <p class=" text-sm mt-2">
            In Short: We may use cookies and other tracking technologies to collect and store your information.
        </p><p class=" text-sm mt-2">
            We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.
        </p>
        <h2 class="mt-8">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">10. DO WE COLLECT INFORMATION FROM MINORS?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">11. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">12. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            <p class=" text-sm mt-2">
            ...
            <h2 class="mt-8">13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
            <p class=" text-sm mt-2">
        ...
        <h2 class="mt-8">14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            <p class=" text-sm mt-2">
            In Short: Yes, we will update this notice as necessary to stay compliant with relevant laws.
        </p><p class=" text-sm mt-2">
            We may update this privacy notice from time to time. The updated version will be indicated by an updated "Revised" date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy notice frequently to be informed of how we are protecting your information.
        </p>
        <h2 class="mt-8">15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
            <p class=" text-sm mt-2">
            If you have questions or comments about this notice, you may email us at __________ or contact us by post at:
        </p><p class=" text-sm mt-2">
            SoulsBorneChallenges
            <br/>__________
            <br/>__________
        </p>
        <h2 class="mt-8 ">16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
            <p class=" text-sm mt-2 mb-32">
            You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: https://soulsbornechallenges.com/account.
        </p>
    </div>
</div>